...
def assign_task_based_on_id(ids):
    ...
    # Same as used internally by HBT-HERONS. 
...
if __name__ == "__main__":
    ...
    parser = MPIArgumentParser(comm, description="Generate HDF5 files that contain information about which particles split between consecutively outputs analysed by HBT-HERONS.")
    parser.add_argument("path_to_config", type=str, help="Location of the configuration file for the run to be analysed with HBT-HERONS")
