...
#define AVAILABLE_PARAMETERS(PARAMETER)                                        \
  ...
  /* Minimum number of bound particles of any type for a subhalo to be 
   * resolved. */                                                              \
  ...
  /* Whether to also save internal binding energies of all particles bound to 
   * subhaloes. */                                                             \
  PARAMETER(bool, SaveBoundParticleBindingEnergies, false)                     \
  /* Whether to also save gravitational potential energies energies of all particles 
   * bound to subhaloes. */                                    \
  ...
  /* Maximum number of particles that can be subsampled during unbinding.
